...
class Settings(BaseSettings):
    ...
    REB_API_KEY: Optional[str] = None  # 한국부동산원 API 키 (레거시 호환)
    REB_API_KEYS: Optional[str] = None  # 한국부동산원 API 키 (여러 개, 콤마로 구분)
    KOSIS_API_KEY: Optional[str] = None  # 통계청 KOSIS API 키
